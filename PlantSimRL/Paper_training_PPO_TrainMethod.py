...
'''In dieser Datei ist eine eigene Trainingsmethode von PPO implementiert, damit jeder Rollout eine ganze Episode in der
Umgebung umfasst. 
'''
...
filename = '\Train_20230301.png'
figure_file = speicherort + filename
    ...
    for i in range(train_episodes):
        ...
        while not done:
            ...
            if done:
                ...
                model.logger.record("rollout/ep_rew", score)
                model.logger.record("rollout/ep_len", n_steps)
